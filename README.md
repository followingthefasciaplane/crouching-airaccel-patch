...
i havent actually tested this and u will need to update the plugin with practical functionality (this is just a concept) and gamedata urself depending on the game but in theory:
